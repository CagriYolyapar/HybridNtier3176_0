...
namespace Project.MvcUI.VmMapping
{
    public class VmMappingProfile : Profile
    {
        public VmMappingProfile()
        {
            ...
            //CreateMap<CreateCategoryRequestModel,CreateCategoryDto>();
            //CreateMap<UpdateCategoryRequestModel,UpdateCategoryDto>();
            //CreateMap<ResponseCategoryDto,CategoryResponseModel>();
        }
    }
}
